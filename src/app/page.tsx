...
import { ShieldQuestion, Calculator, MessageSquare, Search, PlusCircle } from "lucide-react";
      ...
      <main className="flex-grow">
        ...
        <section className="py-16 md:py-24 bg-secondary/30">
            <div className="container mx-auto px-6">
                ...
                <div className="max-w-2xl mx-auto"> {/* Centering the text content */}
                    <div className="space-y-8"> {/* Increased spacing for steps */}
